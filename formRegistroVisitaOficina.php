...
if (in_array($cargoPersonal, $cargosAdmin) && !$esModal) {
  header("Location: informeVisitasOficina.php");
  exit;
}
...
<head>
  ...
  <title>Registro Visita Oficina</title>
      ...
      <div class="col-md-8">
        ...
        <div class="card">
          <div class="header-custom text-center">
            <h4 class="mb-0"><i class="fas fa-building"></i> Registro de Visita</h4>
          </div>

          <div class="card-body">
            <form id="formVisita" method="post" action="guardarVisitaOficina.php" enctype="multipart/form-data">
              ...
              <input type="hidden" name="fecha_creacion_dispositivo" id="fecha_creacion_dispositivo" required>
